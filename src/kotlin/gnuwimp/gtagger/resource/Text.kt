...
package gnuwimp.gtagger.resource
...
object Text {
    ...
    const val APP_ABOUT: String           = "<html><h2>gTagger 1.02</h2>" +
        "<font color=\"blue\">" +
    ...
    const val ERROR_SAVE1_HTML            = "<html><h3>Error! </h3>Saving tracks failed, check the log what track(s) failed!</html>"
    const val ERROR_SAVE2_HTML            = "<html><h3>Error! </h3>Saving tracks failed!</html>"
