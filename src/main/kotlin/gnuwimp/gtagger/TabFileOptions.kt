 ...
 */
class TabFileOptions : LayoutPanel(size = Swing.defFont.size / 2) {
    ...
    private val extCapCheck         = JCheckBox(Labels.LABEL_EXTENSION)
    private val extCapCombo         = ComboBox<String>(Labels.OPTIONS_CAP_EXT)
    ...
    private val nameCapCheck        = JCheckBox(Labels.LABEL_FILENAME)
    private val nameCapCombo        = ComboBox<String>(Labels.OPTIONS_CAP_NAME)
    private val numberCheck         = JCheckBox(Labels.LABEL_TRACK)
    private val numberCombo         = ComboBox<String>(Labels.OPTIONS_NUMBER)
    private val numberSep           = JLabel(Labels.LABEL_NUMBER_SEP)
    private val numberSepInput      = JTextField()
    private val removeIllegalCheck  = JCheckBox(Labels.LABEL_REMOVE_ILLEG)
    ...
    private val setFileNameCheck    = JCheckBox(Labels.LABEL_SET_FILENAME)
    private val setFileNameInput    = JTextField()
    private val undoButton          = JButton(Labels.LABEL_UNDO)
    private val useTitleCheck       = JCheckBox(Labels.LABEL_USE_TITLE)
    ...
    init {
        ...
        extCapCheck.toolTipText         = Labels.TOOL_EXT_CAP
        ...
        nameCapCheck.toolTipText        = Labels.TOOL_NAME_CAP
        numberCheck.toolTipText         = Labels.TOOL_NUMBER
        numberSep.toolTipText           = Labels.TOOL_NUMBER_SEP
        removeIllegalCheck.toolTipText  = Labels.TOOL_REMOVE_ILLEG
        ...
        setFileNameCheck.toolTipText    = Labels.TOOL_SET_FILENAME
        undoButton.toolTipText          = Labels.TOOL_UNDO
        useTitleCheck.toolTipText       = Labels.TOOL_USE_TITLE
