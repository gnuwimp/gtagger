 ...
 */
class TabTrackTable : LayoutPanel(size = Swing.defFont.size / 2) {
    ...
    private val clearButton = JButton(Labels.LABEL_DELETE_TAGS2)
    private val downButton  = JButton(Labels.LABEL_MOVE_DOWN)
    private val upButton    = JButton(Labels.LABEL_MOVE_UP)
    ...
    init {
        ...
        clearButton.toolTipText = Labels.TOOL_DELETE_TAGS2
        downButton.toolTipText  = Labels.TOOL_MOVE_DOWN
        upButton.toolTipText    = Labels.TOOL_MOVE_UP
        ...
        clearButton.addActionListener {
            if (JOptionPane.showConfirmDialog(Main.window, Labels.MESSAGE_ASK_CLEAR_HTML, Labels.DIALOG_CLEAR, JOptionPane.YES_NO_OPTION) == Labels.YES) {
        ...
        table.model = object : AbstractTableModel() {
            ...
            override fun getColumnName(column: Int): String = when (column) {
                ...
                colBitrate -> Labels.LABEL_BITRATE
                colTime -> Labels.LABEL_TIME
                else -> "!"
            }
